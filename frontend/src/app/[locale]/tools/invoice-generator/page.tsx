...
export default function InvoiceGeneratorPage() {
  ...
  const downloadPDF = async () => {
    ...
    items.forEach((item) => {
      ...
      doc.text(
        formatCurrency(item.price).replace(currencySymbols[currency], ""),
        145,
        y + 7,
      );
      doc.text(
    ...
    if (discountPercent > 0) {
      ...
      doc.text(`-${formatCurrency(discountAmount)}`, valueX, y, {
        align: "right",
      });
      y += 7;
    }
    ...
    doc.text("Generated by AddInvoices Free Tools", 105, 285, {
      align: "center",
    });
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
                ...
                <div className="space-y-2 col-span-2 md:col-span-1">
                  ...
                  >
                    ...
                    <option value="MXN" className="bg-[#111111]">
                      MXN ($)
                    </option>
                    <option value="COP" className="bg-[#111111]">
                      COP ($)
                    </option>
                  </select>
                </div>
            ...
            <div className="bg-[#111111] rounded-2xl p-6 md:p-8 border border-white/10 space-y-6">
              ...
              <div className="space-y-4">
                {items.map((item) => (
                  <div
                    key={item.id}
                    className="grid grid-cols-1 md:grid-cols-12 gap-4 bg-white/[0.02] md:bg-transparent p-4 md:p-0 rounded-xl border border-white/10 md:border-none"
                  >
                    ...
                    <div className="col-span-1 md:col-span-2 flex items-center justify-between md:justify-end text-sm md:text-base font-medium text-white px-2">
                      <span className="md:hidden text-xs text-gray-500 px-0">
                        Total:
                      </span>
            ...
            <div className="sticky top-28 space-y-6">
              ...
              <div className="relative aspect-[1/1.414] bg-white rounded-md shadow-2xl overflow-hidden shadow-blue-950/20">
                ...
                <div className="p-8 pt-16 flex flex-col h-full text-[10px] leading-tight text-gray-800">
                    ...
                    <div className="space-y-4">
                      {logo ? (
                        <img
                          src={logo}
                          alt="Business Logo"
                          className="w-16 h-16 object-contain bg-gray-50 rounded p-1 mb-2"
                        />
                      ) : (
                  ...
                  <div className="mb-10">
                    <div className="text-[9px] font-bold text-blue-600 uppercase tracking-wider mb-2">
                      Bill To:
                    </div>
                    <div className="text-sm font-bold text-black">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="space-y-3">
                      {items.map((item) => (
                        <div
                          key={item.id}
                          className="grid grid-cols-12 gap-2 border-b border-gray-100 pb-2"
                        >
                  ...
                  <div className="mt-10 border-t border-gray-100 pt-6">
                    <div className="text-[8px] font-bold text-gray-400 uppercase tracking-widest mb-2">
                      Notes:
                    </div>
          ...
          <div className="bg-[#111111] rounded-2xl p-10 md:p-16 border border-white/10 text-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-ad-secondary text-base md:text-lg mb-10 max-w-2xl mx-auto">
                With AddInvoices you can save your clients, track payments, send
                reminders automatically and manage everything with your voice.
              </p>
