...
export default function Features({
  ...
  useEffect(() => {
    setBaseColor([0.325, 0.58, 0.906]);
    setGlowColor([0.325, 0.58, 0.906]);
  ...
  return (
    <section className="text-foreground relative overflow-hidden px-4 py-12 sm:py-24 md:py-32">
          ...
          <div className="grid grid-cols-12 gap-4 justify-center max-w-7xl mx-auto">
            ...
            >
              <div className="flex flex-col gap-4">
                ...
                <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                  <p className="max-w-[460px]">{c0.body}</p>
                </div>
              </div>
            ...
            >
              <div className="flex flex-col gap-4">
                ...
                <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                  <p className="max-w-[460px]">{c1.body}</p>
                </div>
              </div>
            ...
            >
              <div className="flex flex-col gap-4">
                ...
                <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                  <p className="max-w-[460px]">{c2.body}</p>
                </div>
              </div>
            ...
            >
              <div className="flex flex-col gap-4">
                ...
                <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                  <p className="max-w-[460px]">{c3.body}</p>
                </div>
              </div>
              <div className="flex grow items-center justify-center select-none relative min-h-[200px] md:min-h-[300px] p-2 md:p-4">
                <img
