          ...
          >
            {sponsors.map((sponsor, index) => (
              <div
                ...
                className="flex-shrink-0 flex items-center justify-center w-28 h-28 bg-white/5 backdrop-blur-sm border border-white/10 rounded-lg hover:bg-white/10 transition-all duration-300 group"
              >
